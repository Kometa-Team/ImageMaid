...
| Mode             | Run Mode. **Default:** `report`<br>`report`: File changes will be reported but not done.<br>`rename`: Files will be renamed in the Metadata Directory. (CAN BE RESTORED)<br>`restore`: Restores Renamed Bloat Images.<br>`remove`: Files will be removed in the Metadata Directory. (CANNOT BE RESTORED)<br>**Shell Command:** `-m` or `--mode remove`<br>**Environment Variable:** `MODE=remove` | &#10060; |
...
| Delete Transcode | Clean Plex's PhotoTranscoder Directory.<br>**Shell Command:** `-ct` or `--transcode`<br>**Environment Variable:** `CLEAN_TRANSCODE=True`                                                                                                                                                                                                                                                          | &#10060; |
