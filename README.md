...
* If you have trouble downloading the database using the Plex API you can use `LOCAL_DB=True` to copy the database file rather than downloading it through the Plex API. The assumption here is that you are running the script on the same machine as plex. This is useful in cases where the DB is too large to download.
...
Each global option can be applied in three ways listed in priority order:
...
| Ignore Running        | Ignore Warnings that Plex is currently Running.<br>**Shell Command:** `-i` or `--ignore`<br>**Environment Variable:** `IGNORE_RUNNING=True`                                                                                                                                                                                                                                                                                                                                                                                                                                             | &#10060; |
| Local DB              | The script will copy the database file rather than downloading it through the Plex API (Helps with Large DBs).<br>**Shell Command:** `-l` or `--local`<br>**Environment Variable:** `LOCAL_DB=True`                                                                                                                                                                                                                                                                                                                                                                                     | &#10060; |
...
| Clean PhotoTranscoder | Global Toggle to Clean Plex's PhotoTranscoder Directory.<br>**Shell Command:** `-pt` or `--photo-transcoder`<br>**Environment Variable:** `PHOTO_TRANSCODER=True`                                                                                                                                                                                                                                                                                                                                                                                                                       | &#10060; |
| Empty Trash           | Global Toggle to Run Plex's Empty Trash Operation.<br>**Shell Command:** `-et` or `--empty-trash`<br>**Environment Variable:** `EMPTY_TRASH=True`                                                                                                                                                                                                                                                                                                                                                                                                                                       | &#10060; |
| Clean Bundles         | Global Toggle to Run Plex's Clean Bundles Operation.<br>**Shell Command:** `-cb` or `--clean-bundles`<br>**Environment Variable:** `CLEAN_BUNDLES=True`                                                                                                                                                                                                                                                                                                                                                                                                                                 | &#10060; |
| Optimize DB           | Global Toggle to Run Plex's Optimize DB Operation.<br>**Shell Command:** `-od` or `--optimize-db`<br>**Environment Variable:** `OPTIMIZE_DB=True`                                                                                                                                                                                                                                                                                                                                                                                                                                       | &#10060; |
