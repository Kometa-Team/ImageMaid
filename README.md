...
[![GitHub release (latest by date)](https://img.shields.io/github/v/release/meisnate12/ImageMaid?style=plastic)](https://github.com/meisnate12/ImageMaid/releases)
[![Docker Image Version (latest semver)](https://img.shields.io/docker/v/meisnate12/imagemaid?label=docker&sort=semver&style=plastic)](https://hub.docker.com/r/meisnate12/imagemaid)
[![Docker Pulls](https://img.shields.io/docker/pulls/meisnate12/imagemaid?style=plastic)](https://hub.docker.com/r/meisnate12/imagemaid)
[![Develop GitHub commits since latest stable release (by SemVer)](https://img.shields.io/github/commits-since/meisnate12/ImageMaid/latest/develop?label=Commits%20in%20Develop&style=plastic)](https://github.com/meisnate12/ImageMaid/tree/develop)
...
[![Wiki](https://img.shields.io/readthedocs/kometa?color=%2300bc8c&style=plastic)](https://kometa.wiki/en/latest/pmm/scripts/image-cleanup/)
[![GitHub Sponsors](https://img.shields.io/github/sponsors/meisnate12?color=%238a2be2&style=plastic)](https://github.com/sponsors/meisnate12)
[![Sponsor or Donate](https://img.shields.io/badge/-Sponsor%2FDonate-blueviolet?style=plastic)](https://github.com/sponsors/meisnate12)

Your Plex directories are growing out of control. You use overlays from [Kometa](https://github.com/meisnate12/Kometa) (PMM) or upload lots of custom art from [Title Card Maker](https://github.com/CollinHeist/TitleCardMaker) (TCM) that you no longer want to use or need to eliminate. You don't want to perform the [plex dance](https://www.plexopedia.com/plex-media-server/general/plex-dance/) if you can avoid it. This script can free up gigs of space....
...
1. Clone or [download and unzip](https://github.com/meisnate12/ImageMaid/archive/refs/heads/master.zip) the repo.

```shell
git clone https://github.com/meisnate12/ImageMaid
```
...
```shell
docker run -v <PATH_TO_CONFIG>:/config:rw -v <PATH_TO_PLEX>:/plex:rw meisnate12/imagemaid
```
...
```shell
docker run -v "X:\Media\ImageMaid\config:/config:rw" -v "X:\Plex Media Server:/plex:rw" meisnate12/imagemaid
```
...
A `Dockerfile` is included within the GitHub repository for those who require it, although this is only suggested for those with knowledge of dockerfiles. The official ImageMaid build is available on the [Dockerhub Website](https://hub.docker.com/r/meisnate12/imagemaid).

## Usage

When running ImageMaid, make sure that you are not running any tools which may touch posters, backgrounds or title card images - namely [Kometa](https://github.com/meisnate12/Kometa) or [TitleCardMaker](https://github.com/CollinHeist/TitleCardMaker).
